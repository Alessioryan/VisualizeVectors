...
def main(embedding_dim=50, epochs=20):
    ...
    f = Autoencoder(embedding_dim=embedding_dim)
    ...
    # Save the model
    torch.save(f, f'Models/linear_{embedding_dim}dim.pth')


if __name__ == "__main__":
    main(embedding_dim=4, epochs=5)
    main(embedding_dim=14, epochs=5)
    main(embedding_dim=40, epochs=5)
